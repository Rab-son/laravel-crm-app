                        ...
                        <div class="form-body">
                            <div class="row">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="email" class="form-control @error('emailAddress') is-invalid @enderror" value="{{ old('emailAddress') }}"
                                                placeholder="Email" id="first-name-icon" name="emailAddress">
                                            <div class="form-control-icon">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('budget') is-invalid @enderror" value="{{ old('budget') }}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('message') is-invalid @enderror" value="{{ old('message') }}"
                                                placeholder="Enter departement" name="message">
                                            <div class="form-control-icon">
    ...
    <footer>
        <div class="footer clearfix mb-0 text-muted">
            <div class="float-start">
                <p>2021 &copy; Rabson Sayenda</p>
            </div>
            <div class="float-end">
                <p>Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a
                href="https://rabsonsayenda.herokuapp.com/">Rabson Sayenda</a></p>
            </div>
        </div>
    </footer>
</div>
